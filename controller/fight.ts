...
import { MonsterFightingInterface, MonsterInfoInterface, MonsterSpeedInterface, monsterStatsEnum, monsterType } from "../interfaces/monster.js";
...
const fight = () => {
	...
	const _speedContest = (instance: instanceInterface): string[] => {
